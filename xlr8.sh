...
#     Instagram  :  instagram.com/hacker_world_55 #
#------------------------------------------------------#
...
echo ""
sleep 1
echo "                                    $WHITE Author:$RED ▞▞▞▞▞▖🅰🅳🅷🅸🆃🅷🆈🅰▝▞▞▞▞▞"
echo ""

}

#    Check Internet
wget -q --spider https://github.com/athithya181
...
""" | pv -qL 300
sleep 1.2
echo -e "                                  This is\e[1;0m ஆதித்யா" | pv -qL 150
echo "                                    pudukottai !" | pv -qL 150
echo ""
...
echo ""
echo "          $RED▁▂▄▅▆▇█ Adhithya█▇▆▅▄▂▁"
echo "          $RED what'sapp number (+1 7053153969)
echo ""
echo ""
...
printf "  $RED                     ░░░░░░███████ ]▄▄▄▄▄▄▄▄▃\n"
printf "  $WHITE                      ▂▄▅███\e[1;31AADHIe[1;0m███▅▄▃▂\n"
printf "  $RED                    I███████████████████]\n"
printf "  $WHITE                      ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤...\n"
echo ""
...
echo ""
echo -e "   \e[92m[\e[91m~\e[92m]\e[93m After sending 300 msgs and 60 calls CREATE BY ADTHITHYA!!\e[93m"
echo ""
echo ""
sleep 300
